...
mod tests {
    ...
    fn display() {
        ...
        assert_eq!(format!("{}", gaussint!(0_usize, 0_usize)),  "0");
        assert_eq!(format!("{}", gaussint!(1_usize, 0_usize)),  "1");
        assert_eq!(format!("{}", gaussint!(0_usize, 1_usize)),  "i");
        assert_eq!(format!("{}", gaussint!(2_usize, 0_usize)),  "2");
        assert_eq!(format!("{}", gaussint!(1_usize, 1_usize)),"1+i");
        assert_eq!(format!("{}", gaussint!(2_usize, 1_usize)),"2+i");
    }
